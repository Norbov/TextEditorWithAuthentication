...
namespace TextEditorAuthentication.Controllers
{
    ...
    public class DocumentsController : Controller
    {
        ...
        {
            var applicationDbContext = from d in _context.Documents select d;
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Content,UserId")] Document document)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Content,UserId")] Document document)
        {
            if (id != document.Id)
            {
                return NotFound();
